...
const seed: DatabaseSnapshot = {
  ...
  lessons: [
    ...
    },
    {
      ...
      status: 'canceled',
      original_reference_id: null,
      change_reason: 'Teacher sick. Replaced with robotics workshop.',
    },
    {
      id: 'lesson_mon_2_new',
      class_id: 'class_g1',
    ...
    },
    {
      ...
      class_id: 'class_g1',
      teacher_id: 'user_teacher_1',
      subject: 'Class Event: Shabbat Prep',
      room: 'Classroom',
  ...
  messages: [
    ...
    makeMessage({
      ...
      text_original: 'Welcome to the new school app MVP launch.',
      lang_original: 'en',
      attachments: [],
  ...
  extra_classes: [
    {
      id: 'extra_1',
      title: 'Robotics Club',
      description: 'After-school robotics class',
